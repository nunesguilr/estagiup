...
class Estagio(models.Model):
    aluno = models.OneToOneField(Usuario, on_delete=models.CASCADE, related_name='estagio_realizado', verbose_name="Aluno")
    vaga = models.ForeignKey(Vaga, on_delete=models.CASCADE, related_name='estagios_associados', verbose_name="Vaga")
    supervisor = models.ForeignKey(Usuario, on_delete=models.SET_NULL, null=True, blank=True, related_name='estagios_supervisionados', verbose_name="Supervisor")
    orientador = models.ForeignKey(Usuario, on_delete=models.SET_NULL, null=True, blank=True, related_name='estagios_orientados', verbose_name="Orientador")
